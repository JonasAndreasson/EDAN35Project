...
edaf80::Assignment3::run()
{
	...
	GLuint normal_texture = bonobo::loadTexture2D(config::resources_path("textures/leather_red_02_nor_2k.jpg"));
	...
	demo_sphere.add_texture("diff_texture", diff_texture, GL_TEXTURE_2D);
